...
//    @BindView(R.id.education_school) TextView educationSchool;
//    @BindView(R.id.education_courses) TextView educationCourses;
//    @BindView(R.id.edit_education_btn) ImageButton editEducationBtn;
//
//    @BindView(R.id.add_experience_btn) ImageButton addExperienceBtn;
//    @BindView(R.id.experience_company) TextView experienceCompany;
//    @BindView(R.id.experience_details) TextView experienceDetails;
//    @BindView(R.id.edit_experience_btn) ImageButton editExperienceBtn;
//
//
//
//    @Override
...
//                    } else {
//                        Education education = data.getParcelableExtra(EducationEditActivity.KEY_EDUCATION_ID);
...
////        educationSchool.setText(education.school + " " + education.major + " ( " + dateString + " ) ");
////        educationCourses.setText(formatItems(education.courses));
...
//        ButterKnife.bind(experienceView, this);
//        String dateString = DateUtils.dateToString(experience.startDate)
//                + " ~ " + DateUtils.dateToString(experience.endDate);
//        experienceCompany.setText(experience.company + " (" + dateString + ")");
//        experienceDetails.setText(formatItems(experience.details));
//
